...
public class TheApp {
    ...
    final TheClientConfig config;
    // Reference to the database connection we will use
    private Client m_client;

    private List<Integer> m_logicProcNumbers = Collections.synchronizedList(new ArrayList<Integer>());
   ...
   /**
     ...
     * and validation.
     */
    static class TheClientConfig extends CLIConfig {
    ...
    static Client getClientAndConnect(TheClientConfig config) throws InterruptedException {
     ...
     */
    public TheApp(TheClientConfig config) {
        this.config = config;
        m_client = null;
        try {
        ...
        fullStatsContext = m_client.createStatsContext();
        periodicStatsContext = m_client.createStatsContext();
     ...
     */
    static void connect(Client client, String servers) throws InterruptedException {
    ...
    public synchronized void printResults() throws Exception {
        ...
        m_client.writeSummaryCSV(stats, config.statsfile);
    }
     ...
     *
     */
    class TheClientCallback implements ProcedureCallback {
        @Override
    ...
    int pickLogicNumber() {
        int idx = m_random.nextInt(m_logicProcNumbers.size());
        return m_logicProcNumbers.get(idx);
    }
    ...
    public void runBenchmark() throws Exception {
        ...
        // Populating tables with initial rows should go here
        m_client.callProcedure("Initializer");

        Thread uacThread = new Thread(new UACThread(this));
        uacThread.start();
        while (m_logicProcNumbers.isEmpty()) {
            Thread.sleep(1000);
        }
...
//            int procNum = pickLogicNumber();
//            m_client.callProcedure(new NullCallback(),
//                                 "CommonProc",
//                                 "BusinessLogic" + procNum, null, null, null, null, null, 0);
//        }
        ...
        while (benchmarkEndTime > System.currentTimeMillis()) {
            int procNum = pickLogicNumber();
            m_client.callProcedure(new TheClientCallback(),
                                 "CommonProc",
                                 "BusinessLogic" + procNum, null, null, null, null, null, 0);
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        config.parse(TheApp.class.getName(), args);

        TheApp benchmark = new TheApp(config);
        benchmark.runBenchmark();
    }

    List<Integer> getLogicProcNumbers() {
        return m_logicProcNumbers;
    }
